...
public class WorkoutProgramGenerator {
    ...
    public WorkoutProgramGenerator(InputStream exercisesInputStream) {
    ...
    private List<JSONObject> filterExercisesByMuscle(List<JSONObject> exercises, Set<String> muscleGroups) throws JSONException {
        List<JSONObject> filteredExercises = new ArrayList<>();
        for (JSONObject exercise : exercises) {
            ...
            if (primaryMusclesArray != null) {
                Set<String> primaryMuscles = new HashSet<>();
    ...
    private List<JSONObject> findStretches(List<JSONObject> exercises, Set<String> muscleGroups) throws JSONException {
